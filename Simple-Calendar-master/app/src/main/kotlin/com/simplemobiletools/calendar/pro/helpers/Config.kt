...
class Config(context: Context) : BaseConfig(context) {
    ...
    var addBarChart:Boolean
        get() = prefs.getBoolean(ADD_BarChart, false)
        set(addBarChart) = prefs.edit().putBoolean(ADD_BarChart, addBarChart).apply()

    var addPieChart:Boolean
        get() = prefs.getBoolean(ADD_PieChart, false)
        set(addPieChart) = prefs.edit().putBoolean(ADD_PieChart, addPieChart).apply()
    ...
    var barchartReminders: ArrayList<Int>
        get() = prefs.getString(BARCHART_REMINDERS, REMINDER_CHART_VALUE)!!.split(",").map { it.toInt() }.toMutableList() as ArrayList<Int>
        set(barchartReminders) = prefs.edit().putString(BARCHART_REMINDERS, barchartReminders.joinToString(",")).apply()

    var piechartReminders: ArrayList<Int>
        get() = prefs.getString(PIECHART_REMINDERS, REMINDER_CHART_VALUE)!!.split(",").map { it.toInt() }.toMutableList() as ArrayList<Int>
        set(piechartReminders) = prefs.edit().putString(PIECHART_REMINDERS, piechartReminders.joinToString(",")).apply()
    ...
    var weeklyViewDays: Int
        get() = prefs.getInt(WEEKLY_VIEW_DAYS, 1)
